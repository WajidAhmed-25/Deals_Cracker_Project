...
//   return (
//     <div className="mt-64 w-full px-4 py-6 mx-auto  mb-12 max-w-8xl">
...
//           data-aos-delay="100"
//         >
//           <h2 className="text-4xl font-bold fontColor">Top Deals of the Day</h2>
...
//                   >
//                     <div 
//                       className="overflow-hidden bg-gray-100 rounded-lg shadow-lg w-1/2 mx-auto mt-12"
//                       data-aos="zoom-in"
...
//                           <div className="flex items-center justify-center mx-auto gap-2 mt-2 p-2 text-center">
...
//                         <button onClick={console.log(deal.product_url)}>See More</button>
            ...
            {Array(totalSlides).fill().map((_, slideIndex) => (
              <div key={slideIndex} className="flex flex-shrink-0 w-full gap-4 mt-4">
                {deals.slice(slideIndex * 2, slideIndex * 2 + 2).map((deal, index) => (
                  ...
                  >
                    <div 
                      className="overflow-hidden bg-gray-100 rounded-xl shadow-2xl w-1/2 mx-auto mt-12 border border-[#237da0f8]/10"
                      data-aos="zoom-in"
                      data-aos-delay={300 + (index * 100)}
                    >
                      <div className="relative p-4">

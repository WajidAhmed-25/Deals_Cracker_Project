...
const FilterByCategory = ({ categories = [], applyFilter }) => {
  ...
  return (
    <div className="w-full p-6 bg-white rounded-lg shadow-xl border border-[#237da0f8]/30">
      <div className="pb-2 text-center">
        <h2 className="text-xl font-semibold fontColor">Food Category</h2>
      </div>
      ...
      <div className="space-y-3">
        {categories.map((category) => (
          <div
            ...
            className={`flex items-center justify-between text-lg text-gray-700 hover:text-[#237da0f8] hover:scale-100 hover:transition-all hover:duration-300 hover:font-semibold hover:cursor-pointer ${
